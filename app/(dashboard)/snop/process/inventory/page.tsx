...
import { generatedInventoryData } from '@/app/data/ag-table/inventoryOnHand';
import { generatedSampleData } from '@/app/data/ag-table/inventoryProjection';
console.log(`generatedInventoryData`, generatedInventoryData)
        ...
        <Tabs defaultValue="Meeting" className="tracking-normal">
          ...
          <DemoContainer>
            ...
            <TabsContent value="OnHand">
              ...
              <div>
                <InventoryOnHand data={generatedInventoryData} />
              </div>
            </TabsContent>
            <TabsContent value="Inventory">
              ...
              <div>
                <InventoryProjection data={generatedSampleData} />
              </div>
            </TabsContent>
