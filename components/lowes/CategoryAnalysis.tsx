...
const stats = [
  { name: 'Inventory Turnover', stat: '6.29' },
  { name: 'On-Hand Amount', stat: '$16.73M' },
  { name: 'On-Hand Qty', stat: '$1.2B' },
  { name: 'On Time Shipment %', stat: '66.8%' },
]
...
export default function CategoryAnalysisRoute() {
      ...
      >
        ...
        <div className="relative flex justify-center">
          <span className="isolate inline-flex -space-x-px rounded-md shadow-sm">
            ...
            <button
              type="button"
              className="focu2:z-10 relative inline-flex items-center bg-white px-2  py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
            >
