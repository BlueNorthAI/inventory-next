import { kpiService_m, kpiInv_m } from '~/data/analysis/skuProData'
  ...
  return (
    <>
      <div className="w-full h-screen">
        ...
        {/* charts */}
        <div className="m-4 rounded-lg bg-white shadow-xl shadow-slate-900/10">
          <h3 className="pl-3 py-2 text-lg mx-2 font-medium text-gray-900">
            Service metrics by product group
          </h3>
          <ul className="grid grid-cols-1 md:grid-cols-3 rounded-lg bg-white">
        ...
        <div className="m-4 rounded-lg bg-white shadow-xl shadow-slate-900/10">
          <h3 className="pl-3 py-2 text-lg mx-2 font-medium text-gray-900">
            Service Metrics by SKU for products
          </h3>
          <ul className="p-1 grid grid-cols-1 md:grid-cols-3 rounded-lg bg-white">
            {kpiInv_m.map((kpi) => (
              <li
                key={kpi.Name}
                className="col-span-1 flex flex-col divide-y divide-white"
